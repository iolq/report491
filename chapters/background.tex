...
มีเนื้อเรื่องที่น่าติดตามและน่าสนใจ ทำให้ผู้เล่นอยากเล่นจนจบและตามหาเรื่องราวที่ถูกซ่อนไว้ ตัวอย่างรูปที่ 2.1 และ 2.2
\begin{figure}[h]
  \centering
...
\subsection{Unity}
\subsubitem \textbf{Unity} \cite{unity:program} เป็นโปรแกรมที่ใช้ในการพัฒนาวอฟต์แวร์และการจำลองต่างๆ เช่น เกม ภาพยนต์ แอนิเมชั่น เป็นต้น ซึ่งมีเครื่องมือที่ช่วยในการพัฒนาเกมต่างๆมากมาย อีกทั้งยังสามารถใช้ภาษา C$\#$ ในการช่วยพัฒนาตัวเกมให้มีความหลากหลาย รูปที่ 2.11 
...
\subsection{Discord}
\subsubitem \textbf{Discord} \cite{discord:software} เป็นซอฟต์แวร์สำหรับการสื่อสารผ่านทางตัวอักษรหรือเสียงทางเครือข่ายอิมเทอร์เน็ต สามารถสร้างห้องสำหรับพูดคุยฌฉพาะกลุ่มได้ อีกทั้งยังสามารถที่จะแชร์หน้าจอให้ผู้อื่นสามารถเข้ามาดู ช่วยในการสื่อสารของทีมและติดตามงาน รูปที่ 2.12
\begin{figure}[h]
  \centering
