...
\subsection{Jira}
\subsubitem \textbf{Jira} เป็นแอปพลิเคชั่นที่พัฒนาโดย Atlassian ช่วยให้ติดตามความคืบหน้าของงานและจุดบกพร่อง และยังช่วยให้โครงการมีความคล่องตัวมากขึ้น

\subsection{Unity Asset Store}
\begin{enumerate}
  \item \textbf{Japanese School - Stylized}
  \item \textbf{Casual 1 - Anime Girl Characters}
\end{enumerate}
