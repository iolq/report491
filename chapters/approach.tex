...
\begin{enumerate}
    \item ฉากบ้านแพรวที่ประตู้เข้าบ้าน ก่อนที่จะเข้าบ้านของแพรวได้จำเป็นจะต้องใส่รหัสผ่านเพื่อที่จะปลดล็อค การที่จะได้รหัสผ่านมานั้นจำเป็นจะต้อง
    \item ฉากโรงเรียนตอนกลางคืนที่ห้อง 
\end{enumerate}
\begin{figure}[h]
    \centering
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|p{8cm}|}
        ...
        \hline
    \end{tabular}
    \caption[ตารางแสดงข้อมูลของ item ใช้งาน]{ตารางแสดงข้อมูลของ item ใช้งาน}
\end{table}
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|p{8cm}|}
        \hline
        กุญแจอาคารเรียน & ได้รับหลังจากที่พูดคุยกับยาม จะปรากฏให้เก็บได้ทางด้านหลังของยาม \\
        \hline
        กุญแจโรงเรียน & ได้รับหลังจากที่พูดคุยกับยาม จะปรากฏให้เก็บได้ทางด้านหลังของยาม \\
        \hline
        แฟ้มประวัติ & ได้รับหลังจากเข้าไปยังเคาน์เตอร์ที่โรงพยาบาล จะปรากฏอยู่บนเคาน์เตอร์\\
        \hline
    \end{tabular}
    \caption[ตารางแสดงข้อมูลของ question item]{ตารางแสดงข้อมูลของ question item}
\end{table}
