...
\subsubitem \textbf{School Uniforms - Anime Boy Characters} \cite{School-Uniforms-Anime-Boy-Characters:asset} ใช้เป็นตัวละครประกอปนักเรียนชาย ตัวอย่างรูปที่ 3.3
\begin{figure}[h]
  \centering
...
\subsection{\ifenglish Story line\else ไอเทม\fi }
